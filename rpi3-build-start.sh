...
echo "Debian GNU/Linux 12 (bookworm) on ${B}${R}Raspberry Pi 3${N}"
echo " "
...
export CFLAGS="-fPIC -O3 -march=armv8-a+fp+simd -mtune=cortex-a53"
export CXXFLAGS="-fPIC -O3 -march=armv8-a+fp+simd -mtune=cortex-a53"

chmod +x ./autoconf_pi3.sh
chmod +x ./build_files/build_environment/install_deps_pi3.sh

cp ./GNUmakefile_pi3 ./GNUmakefile

cd ..
./blender-rpi-v2.79/autoconf_pi3.sh
